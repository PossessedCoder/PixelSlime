...
class Menu(BaseWindow):
    ...
    def __init__(self):
        ...
        self._button_levels.set_not_hovered_view(load_media(Media.LEVELS_PREVIEW), background_color=(78, 78, 78),
                                                 border_radius=19)
        self._button_editor = Button(1150, 450, 250, 250, parent=self)
        ...
        self.back_button = Button(self.get_rect().centerx - 35, self.get_rect().h - 70, 55, 55, parent=self)
    ...
    def draw(self):
        ...
        self.blit(frame, rect=frame.get_rect(center=(self.get_rect().centerx - 20, SCREEN_HEIGHT // 5)))
